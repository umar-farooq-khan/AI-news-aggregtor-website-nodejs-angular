...
//   console.log("callapi")
//   url =
//     "http://newsapi.org/v2/top-headlines?country=us&from=2021-3-04&category=entertainment&page=${i}&pageSize=50&sortBy=publishedAt&apiKey=cc742bddd3154adabcc65f45f78d006e"
//   var options = {
//     path: url,
//     json: true,
//   };
...
//
//     qstring =
//       "INSERT INTO entertainment(author,title,description,url,urlToImage,publishedAt) VALUES (%s, %s, %s ,%s , %s, %s)";
//     querystring = parse(
//       qstring,
//       author,
//       title,
