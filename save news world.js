...
function callapi()
{
  console.log("callapi")
  url =
    "http://newsapi.org/v2/everything?q=bbc&from=2020-12-05&page=${i}&pageSize=50&sortBy=publishedAt&apiKey=cc742bddd3154adabcc65f45f78d006e";
  var options = {
    path: url,
    json: true,
  };
...
function savetodb(body) {
  ...
  for (
    ...
    qstring =
      "INSERT INTO world(author,title,description,url,urlToImage,publishedAt) VALUES (%s, %s, %s ,%s , %s, %s)";
    querystring = parse(
      qstring,
      author,
      title,
